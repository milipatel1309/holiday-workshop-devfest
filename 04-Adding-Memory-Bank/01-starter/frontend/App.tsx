...
export default function App() {
  ...
  return (
    <div className="flex w-full h-screen relative bg-gradient-to-b from-black via-[#001a0d] to-[#0a2f1e] overflow-hidden">
      {/* 3D Scene Container */}
      ...
      <div className="w-[400px] h-full relative z-10 shadow-2xl border-l border-white/10 flex-shrink-0">
